...
- Have a single point of truth on what reusable components should look like, how they should behave, and what options they provide.
- Allow product designers and front-end developers to have a shared understanding of how these common elements are specified and implemented
- Allow QA a common base of reference when testing implementation of features using these common elements
- Give new or outside developers important context about available components and how to use them
